(ns clojure-vulkan.render-pass
  (:require [clojure-vulkan.globals :refer [LOGICAL-DEVICE RENDER-PASS-POINTER SWAP-CHAIN-IMAGE-FORMAT]]
...
(defn create-render-pass []
  (util/with-memory-stack-push ^MemoryStack stack
    (let [color-attachment-descriptions (doto (VkAttachmentDescription/calloc 1 stack)
          ...
          color-attachment-reference (doto (VkAttachmentReference/calloc stack)
                                       (.attachment 0)
          ...
          subpass-descriptions (doto (VkSubpassDescription/calloc 1 stack)
                                 ...
                                 (.pColorAttachments color-attachment-reference))
